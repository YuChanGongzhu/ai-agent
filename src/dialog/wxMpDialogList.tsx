...
export const WxMpDialogList: React.FC<WxMpDialogListProps> = ({
  ...
  return (
    <div className="bg-white flex flex-col h-full border-r overflow-hidden max-w-full overflow-x-hidden">
        ...
        {isLoading ? (
          ...
          <ul>
            {filteredDialogs.map((dialog) => (
              <li
                key={dialog.room_id}
                className={clsx("p-3 border-b cursor-pointer hover:bg-gray-50 transition-colors", {
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-baseline">
                      ...
                      <span className="text-xs text-gray-500 whitespace-nowrap ml-2">
                        {new Date(dialog.msg_datetime).toLocaleTimeString([], {
                          month: "2-digit",
                          day: "2-digit",
                          hour: "2-digit",
                          minute: "2-digit",
