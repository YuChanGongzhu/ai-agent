...
interface AnalysisMomentsProps {
...
const AnalysisMoments: React.FC<AnalysisMomentsProps> = ({
  customerInfo,
  selectedAccount,
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-4 h-[30vh] flex flex-col mt-4">
      {/* Header */}
...
export default AnalysisMoments;
